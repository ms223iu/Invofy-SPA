    ...
    <div class="columns">
      <div class="column">
        ...
        <div class="field">
          ...
          <p :class="{ 'control': true }">
            <input v-model="address.post" v-validate="'required'" @input="inputChanged()" :class="{'input': true, 'is-danger': errors.has('postnummer')}" name="postnummer" type="text" placeholder="postnummer" autocomplete="off" autocorrect="off" spellcheck="false" :readonly="isLoading">
          </p>
        </div>
      </div>
      ...
      <div class="column">
        <div class="field">
          ...
          <p :class="{ 'control': true }">
            <input v-model="address.city" v-validate="'required'" @input="inputChanged()" :class="{'input': true, 'is-danger': errors.has('stad')}" name="stad" type="text" placeholder="stad" autocomplete="off" autocorrect="off" spellcheck="false" :readonly="isLoading">
          </p>
        </div>
        ...
        <div class="field">
          ...
          <p :class="{ 'control': true }">
            <input v-model="address.country" v-validate="'required'" @input="inputChanged()" :class="{'input': true, 'is-danger': errors.has('land')}" name="land" type="text" placeholder="land" autocomplete="off" autocorrect="off" spellcheck="false" :readonly="isLoading">
          </p>
        </div>
        <div class="field">
